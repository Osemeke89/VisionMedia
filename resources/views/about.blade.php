    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4">
            <p>
              <img src="images/img_11.jpg" alt="Image" class="img-fluid" style="height: 400px; width: 400px;">
            </p>
          </div>
          <div class="col-lg-8 pl-md-5">
            <p>The Vision Media was initiated in the year 2021 by ANITA EBOIGBE. The motion is driven by the students of 
               Samuel Adegboyega University, Ogwa, Edo state. Samuel Adegboyega University
               is a faith based institution established in 2011 and owned by The Apostolic Church Nigeria.</p>
            <p>The Vision Media is set to be a citadel of learning and empowerment for students of the university and world at large.</p>
            <p>The blog will constantly notify the public on current happenings across the globe and dedicatedly offer premium content 
               that will be geared at educating, entertaining and keeping the masses informed.</p>
